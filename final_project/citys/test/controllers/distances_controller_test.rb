...
class DistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post distances_url, params: { distance: { destiny: @distance.destiny, origin: @distance.origin, value: @distance.value } }
    end
  ...
  test "should update distance" do
    patch distance_url(@distance), params: { distance: { destiny: @distance.destiny, origin: @distance.origin, value: @distance.value } }
